      ...
      <div className="max-w-7xl mx-auto mt-12 px-4">
          ...
          {activeTab === 'MEDIA' ? (
              ...
              <div className="max-w-2xl">
                  <h3 className="text-white font-condensed text-xl uppercase mb-6 flex items-center gap-2">
                      <Box size={18} /> General Site Settings
                  </h3>
                  ...
                  <div className="bg-[#151515] p-8 border border-stone-800 rounded-sm space-y-8">
                      ...
                      <div className="border-b border-stone-800 pb-8 mb-8">
                          <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Logo Management</h4>
                          <p className="text-stone-500 text-xs mb-4">Choose between a text logo or upload an image logo.</p>
                              ...
                              <div className="flex gap-6 mb-2 border-b border-stone-800 pb-4">
                                  <label className="flex items-center gap-2 cursor-pointer group">
                                      ...
                                      <input 
                                          ...
                                          className="hidden"
                                      />
                                      <span className={`text-sm font-bold uppercase tracking-wider ${logoType === 'text' ? 'text-white' : 'text-stone-500 group-hover:text-stone-300'}`}>Text Logo</span>
                                  </label>
                                  <label className="flex items-center gap-2 cursor-pointer group">
                                      ...
                                      <input 
                                          ...
                                          className="hidden"
                                      />
                                      <span className={`text-sm font-bold uppercase tracking-wider ${logoType === 'image' ? 'text-white' : 'text-stone-500 group-hover:text-stone-300'}`}>Image Logo</span>
                                  </label>
                              </div>

                              {logoType === 'text' ? (
                                  <div>
                                      <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Logo Text</label>
                                  ...
                                  <div>
                                      <div className="bg-black p-4 border border-stone-800 mb-4">
                                          <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Current Logo Image</label>
                                          {siteSettings.find(s => s.key === 'logo_image_url')?.value ? (
                                              <img src={siteSettings.find(s => s.key === 'logo_image_url')?.value} alt="Current Logo" className="h-12 object-contain bg-stone-900/50 p-2" />
                                          ) : (
                                              <div className="text-stone-500 text-xs italic">No image uploaded</div>
                                          )}
                                      </div>

                                      <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Upload New Logo (PNG/SVG Recommended)</label>
                                      <input 
                                          type="file" 
                                      ...
                                      {logoImageFile && (
                                          <div className="mt-2 bg-stone-900/50 p-4 border border-stone-800">
                                              <p className="text-[10px] uppercase font-bold text-stone-500 mb-2">Preview:</p>
                                      ...
                                      >
                                          {isUploading ? 'Uploading...' : 'Upload & Update Logo'}
                                      </button>
                                  </div>
                              )}
                          </div>
                      ...
                      <div>
                          <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Homepage Hero Media</h4>
                          <p className="text-stone-500 text-xs mb-4">Choose between a video or an image for the homepage background.</p>
                          ...
                          <div className="flex flex-col gap-4">
                              ...
                              <div className="flex gap-6 mb-2 border-b border-stone-800 pb-4">
                                  <label className="flex items-center gap-2 cursor-pointer group">
                                      ...
                                      <input 
                                          ...
                                          className="hidden"
                                      />
                                      <span className={`text-sm font-bold uppercase tracking-wider ${heroMediaType === 'video' ? 'text-white' : 'text-stone-500 group-hover:text-stone-300'}`}>Video Mode</span>
                                  </label>
                                  <label className="flex items-center gap-2 cursor-pointer group">
                                      ...
                                      <input 
                                          ...
                                          className="hidden"
                                      />
                                      <span className={`text-sm font-bold uppercase tracking-wider ${heroMediaType === 'image' ? 'text-white' : 'text-stone-500 group-hover:text-stone-300'}`}>Image Mode</span>
                                  </label>
                              </div>

                              <div className="bg-black p-4 border border-stone-800">
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Current Media URL</label>
                                  <div className="text-stone-300 text-xs break-all font-mono">
                                      {siteSettings?.find(s => s.key === 'hero_media_url')?.value || siteSettings?.find(s => s.key === 'hero_video_url')?.value || 'Not set'}
                                  </div>
                              </div>

                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Upload New {heroMediaType === 'video' ? 'Video (MP4)' : 'Image (JPG/PNG)'}</label>
                                  <input 
                                    type="file" 
                              ...
                              <button 
                                ...
                                onClick={async () => {
                                    ...
                                    if (url) {
                                        ...
                                        alert(`${heroMediaType === 'video' ? 'Video' : 'Image'} updated successfully!`);
                                    }
                                    setIsUploading(false);
                                }}
                              ...
                              >
                                  {isUploading ? 'Uploading & Updating...' : `Upload & Update ${heroMediaType === 'video' ? 'Video' : 'Image'}`}
                              </button>
                          </div>
                      </div>
                      ...
                      <div className="border-t border-stone-800 pt-8">
                          <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Homepage Hero Text</h4>
                          <p className="text-stone-500 text-xs mb-4">Update the main title and subtitle displayed on the homepage hero section.</p>
                          
                          <div className="space-y-4">
                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Hero Title</label>
                                  <div className="flex gap-2">
                                      <input 
                              ...
                              <div className="border-t border-stone-800 pt-8 mt-4">
                                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Story Section</h4>
                                  <p className="text-stone-500 text-xs mb-4">Update the title and description for the story/flagship section.</p>
                                  ...
                                  <div className="space-y-4">
                                      ...
                                      <div>
                                          <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Story Image (Upload)</label>
                                          <div className="flex flex-col gap-2">
                                              ...
                                              <div className="bg-black p-4 border border-stone-800">
                                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Current Image URL</label>
                                                  <div className="text-stone-300 text-xs break-all font-mono">
                                                      {siteSettings?.find(s => s.key === 'story_image_url')?.value || 'Default Image'}
                                                  </div>
                                              </div>
                                              ...
                                              <button 
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    if (url) {
                                                        ...
                                                        alert('Story image updated successfully!');
                                                    }
                                                    setIsUploading(false);
                                                }}
                                                className="bg-white text-black font-bold uppercase py-3 text-xs tracking-widest hover:bg-stone-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                                              >
                                                  {isUploading ? 'Uploading...' : 'Upload & Update Image'}
                                              </button>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div className="border-t border-stone-800 pt-8 mt-4">
                                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Bespoke Projects Section</h4>
                                  <p className="text-stone-500 text-xs mb-4">Update the video and text for the Bespoke Projects section.</p>
                                  
                                  <div className="space-y-4">
                                      <div>
                                          <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Section Title</label>
                                          <input 
                                            className="w-full bg-[#0a0a0a] border border-stone-700 p-3 text-white text-sm focus:border-white outline-none select-text cursor-text"
                                      ...
                                      <div>
                                          <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Background Video (Upload)</label>
                                          <div className="flex flex-col gap-2">
                                              <input 
                                                type="file" 
                                              ...
                                              <div className="bg-black p-4 border border-stone-800">
                                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Current Video URL</label>
                                                  <div className="text-stone-300 text-xs break-all font-mono">
                                                      {siteSettings?.find(s => s.key === 'bespoke_video_url')?.value || 'Default Video'}
                                                  </div>
                                              </div>
                                              ...
                                              <button 
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    if (url) {
                                                        ...
                                                        alert('Bespoke video updated successfully!');
                                                    }
                                                    setIsUploading(false);
                                                }}
                                                className="bg-white text-black font-bold uppercase py-3 text-xs tracking-widest hover:bg-stone-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                                              >
                                                  {isUploading ? 'Uploading...' : 'Upload & Update Video'}
                                              </button>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              <p className="text-[10px] text-stone-500 italic">* Changes are saved automatically when you click outside the input field.</p>
                          </div>

                          <div className="border-t border-stone-800 pt-8 mt-4">
                                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Footer Settings</h4>
                                  <p className="text-stone-500 text-xs mb-4">Update the footer text and manage social media links.</p>
                                  ...
                                  <div className="space-y-4">
                                      ...
                                      <div className="border-t border-stone-800 pt-4 mt-2">
                                          ...
                                          <div className="space-y-2 mb-4">
                                              ...
                                              {socialLinks.length === 0 && <p className="text-stone-600 text-xs italic">No links added yet.</p>}
                                          </div>

                                          {/* Add new link */}
                                          <div className="bg-stone-900/30 p-3 border border-stone-800/50">
                                              <p className="text-[10px] font-bold text-stone-400 uppercase mb-2">Add New Link</p>
                              ...
                              <div className="border-t border-stone-800 pt-8 mt-4">
                                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Ethos / Philosophy Section</h4>
                                  <p className="text-stone-500 text-xs mb-4">Update the content for the Philosophy page.</p>
                                  
                                  <div className="space-y-4">
                                      <div>
                                          <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Page Title</label>
                                          <input 
                                            className="w-full bg-[#0a0a0a] border border-stone-700 p-3 text-white text-sm focus:border-white outline-none select-text cursor-text"
                              ...
                              <div className="border-t border-stone-800 pt-8 mt-4">
                                  <h4 className="text-white font-bold uppercase tracking-wider text-sm mb-4">Designers Settings</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <div className={`bg-[#151515] p-6 border rounded-sm sticky top-32 transition-colors duration-300 ${editingId ? 'border-yellow-600/50' : 'border-stone-800'}`}>
                      <div className="flex justify-between items-center mb-6">
                          <h3 className={`font-condensed text-xl uppercase flex items-center gap-2 ${editingId ? 'text-yellow-500' : 'text-white'}`}>
                              ...
                              {editingId ? 'Edit' : 'Add New'} {activeTab === 'PRODUCTS' ? 'Product' : (activeTab === 'CATEGORIES' ? 'Category' : 'Designer')}
                          </h3>
                          {editingId && (
                      ...
                      {activeTab === 'CATEGORIES' ? (
                          <form onSubmit={submitCategory} className="space-y-6">
                                  ...
                                  <div className="flex flex-col gap-2">
                                      ...
                                      {catForm.image && !catImageFile && (
                                          <div className="text-[10px] text-stone-600 truncate flex items-center gap-2">
                                            <span className="w-2 h-2 rounded-full bg-green-500"></span> Current: {catForm.image.substring(0, 30)}...
                                          </div>
                                      )}
                                  </div>
                              </div>
                              ...
                              <button disabled={isUploading} type="submit" className={`w-full font-bold uppercase py-3 text-xs tracking-widest transition-colors ${editingId ? 'bg-yellow-600 hover:bg-yellow-500 text-white' : 'bg-white hover:bg-stone-200 text-black'} disabled:opacity-50`}>
                                  {isUploading ? 'Uploading...' : (editingId ? 'Update Category' : 'Save Category')}
                              </button>
                          </form>
                      ) : activeTab === 'DESIGNERS' ? (
                          <form onSubmit={submitDesigner} className="space-y-4">
                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Name</label>
                                  <input 
                                    className="w-full bg-[#0a0a0a] border border-stone-700 p-3 text-white text-sm focus:border-white outline-none"
                              ...
                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Profile Image (Upload)</label>
                                  <div className="flex flex-col gap-2">
                                      <input 
                                        type="file" 
                                      ...
                                      {desForm.image_url && !desImageFile && (
                                          <div className="text-[10px] text-stone-600 truncate flex items-center gap-2">
                                            <span className="w-2 h-2 rounded-full bg-green-500"></span> Current: {desForm.image_url.substring(0, 30)}...
                                          </div>
                                      )}
                                  </div>
                              </div>
                              ...
                              <button disabled={isUploading} type="submit" className={`w-full font-bold uppercase py-3 text-xs tracking-widest transition-colors ${editingId ? 'bg-yellow-600 hover:bg-yellow-500 text-white' : 'bg-white hover:bg-stone-200 text-black'} disabled:opacity-50`}>
                                  {isUploading ? 'Uploading...' : (editingId ? 'Update Designer' : 'Save Designer')}
                              </button>
                          </form>
                      ) : (
                          <form onSubmit={submitProduct} className="space-y-4">
                               <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Select Category</label>
                                  <select 
                              ...
                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">Product Image (Upload)</label>
                                  <div className="flex flex-col gap-2">
                                      <input 
                                        type="file" 
                                      ...
                                      {prodForm.image && !prodImageFile && (
                                          <div className="text-[10px] text-stone-600 truncate flex items-center gap-2">
                                            <span className="w-2 h-2 rounded-full bg-green-500"></span> Current: {prodForm.image.substring(0, 30)}...
                                          </div>
                                      )}
                                  </div>
                              </div>
                              ...
                              <div>
                                  <label className="text-[10px] uppercase font-bold text-stone-500 block mb-2">More Info (Optional)</label>
                              ...
                              <div className="border border-stone-800 p-4 bg-stone-900/50">
                                  <h4 className="text-[10px] font-bold uppercase text-stone-400 mb-3 flex items-center gap-2"><FileDown size={14}/> Downloads Configuration</h4>
                                  
                                  <div className="space-y-4">
                                      {/* Sheet */}
                                      <div>
                                          <label className="text-[9px] uppercase font-bold text-stone-500 block mb-1">Product Sheet (PDF)</label>
                                          ...
                                          {prodForm.pdf_sheet && !fileSheet && <span className="text-[9px] text-green-500">File exists</span>}
                                      </div>

                                      {/* Images */}
                                      <div>
                                          <label className="text-[9px] uppercase font-bold text-stone-500 block mb-1">High-Res Images (ZIP/PDF)</label>
                                          <input type="file" ref={fileImagesRef} accept=".pdf,.zip,.rar"
                                            onMouseDown={(e) => e.stopPropagation()}
                                            onChange={e => e.target.files && setFileImages(e.target.files[0])}
                                            className="w-full text-xs text-stone-400 file:mr-2 file:py-1 file:px-2 file:border-0 file:text-[10px] file:bg-stone-800 file:text-white cursor-pointer" />
                                            {prodForm.pdf_images && !fileImages && <span className="text-[9px] text-green-500">File exists</span>}
                                      </div>

                                      {/* Technical */}
                                      <div>
                                          <label className="text-[9px] uppercase font-bold text-stone-500 block mb-1">2D / 3D Technical (ZIP/PDF)</label>
                                          <input type="file" ref={fileTechRef} accept=".pdf,.zip,.rar,.dwg"
                                            onMouseDown={(e) => e.stopPropagation()}
                                            onChange={e => e.target.files && setFileTech(e.target.files[0])}
                                            className="w-full text-xs text-stone-400 file:mr-2 file:py-1 file:px-2 file:border-0 file:text-[10px] file:bg-stone-800 file:text-white cursor-pointer" />
                                            {prodForm.pdf_technical && !fileTech && <span className="text-[9px] text-green-500">File exists</span>}
                                      </div>
                                  </div>
                              </div>
                              ...
                              <button disabled={isUploading} type="submit" className={`w-full font-bold uppercase py-3 text-xs tracking-widest transition-colors ${editingId ? 'bg-yellow-600 hover:bg-yellow-500 text-white' : 'bg-white hover:bg-stone-200 text-black'} disabled:opacity-50`}>
                                  {isUploading ? 'Uploading & Saving...' : (editingId ? 'Update Product' : 'Save Product')}
                              </button>
                          </form>
                      )}
                  </div>
              ...
              <div className="lg:col-span-2">
                   <h3 className="text-white font-condensed text-xl uppercase mb-6 flex items-center gap-2">
                       <FileText size={18} /> Manage {activeTab === 'PRODUCTS' ? 'Products' : (activeTab === 'CATEGORIES' ? 'Categories' : 'Designers')}
                   </h3>

                   <div className="space-y-4">
                       {activeTab === 'CATEGORIES' ? (
                           categories.length === 0 ? <p className="text-stone-500 italic">No categories found. Add one to get started.</p> :
                           categories.map(cat => (
                           ...
                           designers.length === 0 ? <p className="text-stone-500 italic">No designers found. Add one to get started.</p> :
                           designers.map(des => (
                               <div key={des.id} className={`bg-[#151515] p-4 border flex justify-between items-center group transition-colors ${editingId === des.id ? 'border-yellow-600' : 'border-stone-800 hover:border-stone-600'}`}>
                                   ...
                                   <div className="flex gap-2">
                                       ...
                                       <button onClick={() => { if(confirm('Delete this designer?')) deleteDesigner(des.id); }} className="p-2 text-stone-500 hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
                                   </div>
                               </div>
                           ))
                       ) : (
                           products.length === 0 ? <p className="text-stone-500 italic">No products found.</p> :
                           products.map(prod => (
